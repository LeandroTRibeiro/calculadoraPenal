            ...
            <main className="h-main mobile-g:h-main-mobile flex items-center px-10 mobile-g:px-3 tablet-m:flex-col-reverse tablet-m:justify-center">
                <div className="flex-1 flex flex-col gap-5 tablet-m:flex-initial">
                    <div className="flex flex-col gap-5 laptop-p:gap-3 mobile-g:gap-2 mobile-m:gap-1">
                        ...
                        <p className="text-base tablet-m:text-sm">Explore e experimente a Calculadora Penal hoje mesmo e descubra como podemos facilitar o seu dia a dia no universo do Direito Penal!</p>
                    </div>
